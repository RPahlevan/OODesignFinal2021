 ...
 * client(CarrierManagementSystemClient) to Carrier builder class.
 */
public class CarrierManagementSystemDirector {
     ...
     */
    public void CreateLTECarrier(Integer carrierId, List<RFPorts> rfPorts, CarrierFrequencies carrierFrequencies,
     ...
     *                           created.
     */
    public void CreateWCDMACarrier(Integer carrierId, List<RFPorts> rfPorts, CarrierFrequencies carrierFrequencies,
                                   Double transmittingPower) {
