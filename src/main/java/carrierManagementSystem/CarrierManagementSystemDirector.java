 ...
 * @author epahram
 *
 * This class is responsible to create LTE carrier and WCDMA carrier. We can call this class director as it will direct the creation command from client(CarrirerManagementSystemClient) to Carrier builder class.
 */
public class CarrierManagementSystemDirector {
	 ...
	 * This method will ask CarrierBuilder children classe - LTECarrierBuilder- to create LTE carrier based on inputs.  
	 * 
	 * @param carrierId Carrier ID will be assigned to LTE carrier. 
	 * @param rfPorts LTE carrier needs 4 ports. These RF ports can be selected from RFPorts enum class. 
	 * @param carrierFrequencies LTE carrier needs specific band to operate. List of LTE carrier frequency are available in CarrierFrequencies enum class.
	 ...
	 * This method will ask CarrierBuilder children class - WCDMACarrierBuilder- to create LTE carrier based on inputs.  
	 * 
	 * @param carrierId Carrier ID will be assigned to WCDMA carrier. 
	 * @param rfPorts WCDMA carrier needs 2 ports. These RF ports can be selected from RFPorts enum class. 
	 * @param carrierFrequencies WCDMA carrier needs specific band to operate. List of WCDMA carrier frequency are available in CarrierFrequencies enum class.
